...
./fasttext cbow -input     ../data/fasttext-inputs.txt -output cbow20_min2_neg15_ws20_epoch7  -minCount 2 -neg 15 -ws 20 -epoch 7 -dim 20

rm skip100_min1_neg15_ws10_epoch7.bin skip20_min2_neg15_ws20_epoch7.bin cbow100_min1_neg15_ws10_epoch7.bin cbow20_min2_neg15_ws20_epoch7.bin
